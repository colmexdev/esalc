		...
		success: function(result){
			...
			for(var i = 0; i < vids.length; i++){
				vids_html = vids_html + '<dt>' +
                              '<a href="#"><h5 class="m-0 text-left">' + vids[i]["titulo"] + '</h5>' + //'<h5 class="verde-obscuro mt-10 mb-0">Miguel Basáñez; José Romero; Gerardo Esquivel; Leonardo Curzio</h5></a>' +
                        '</dt>' +
                        '<dd>' +
                          '<div class="row">' +
                            '<div class="col-md-7">' +
                              '<p class="text-left"><strong class="azul-obscuro">Descripción:</strong> <span>' + vids[i]["descripcion"] + '</span></p>' +
                              '<p class="text-left"><strong class="azul-obscuro">Fecha de Publicación:</strong> <span>' + vids[i]["fecha"] + '</span></p>' +
                            '</div>' +
                            '<div class="col-md-5">' +
                              '<p class="text-left"><strong class="azul-obscuro">Tema:</strong> <span>' + find_tag(vids[i]["tags"]) + '</span></p>' +
                              '<p><a class="button medium  gray-light" href="https://www.youtube.com/watch?v=' + vids[i]["v_id"] + '" target="_blank">VER VIDEO <span class="icon icon-basic-video"></span></a></p>' +
                            '</div>' +
                          '</div>' +
                        '</dd>';
			}
