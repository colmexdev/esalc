...
function fill_seminarios(conds){
	conds = conds || "";
	...
	$.ajax({
		...
		success: function(result){
			...
			for(var i = 0; i < result["videos"].length; i++){
				//var fecha_vid = result["videos"][i]["fecha"].substring(0,10).split("-");
				vids_html = vids_html + '<dt>' +
                    '<a href="#"><h5 class="m-0 text-left">' + result["videos"][i]["tituloActividad"] + '</h5><h5 class="verde-obscuro mt-10 mb-0">Seminario de América Latina</h5></a>' +
                  '</dt>' +
                  '<dd>' +
                    '<div class="row">' +
                      '<div class="col-md-7">' +
                      ...
                      '<div class="col-md-5">' +
                        //'<p class="text-left"><strong class="azul-obscuro">Tema:</strong> <span>Crisis global</span></p>'
                        //'<p class="text-left"><strong class="azul-obscuro">Tipo de evento:</strong> <span>Conferencia</span></p>'
                        '<p class="text-left"><strong class="azul-obscuro">Lugar:</strong> <span>' + result["videos"][i]["sede"] + '</span></p>' +
                      '</div>' +
                      '<div class="col-md-12">' +
                        '<p class="text-left"><strong class="azul-obscuro">Enlace al evento:</strong> <a href="' + result["videos"][i]["liga"] + '" target="_blank" class="a-inv">' + result["videos"][i]["liga"] + '</a></p>' +
