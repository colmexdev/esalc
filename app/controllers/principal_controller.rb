class PrincipalController < ApplicationController
  ...
  def consulta_eventos
    ...
    begin
      ...
      @resultado.do
      @resultado = cliente.execute("SELECT * FROM dbo.vw_EventosCategoria ORDER BY PARSE(fechaInicio AS DATE USING 'es-ES') ASC, horaInicio ASC OFFSET " + offset + " ROWS " + (params.key?(:limit) ? ("FETCH NEXT " + params[:limit] + " ROWS ONLY;") : ";")
